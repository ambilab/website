...
<button
    ...
    class="meta [&:hover,&:focus]:text-text-primary [&:hover,&:focus]:bg-active flex cursor-pointer items-center px-2 py-[6px] uppercase text-text-secondary disabled:opacity-50"
