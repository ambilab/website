...
<button
    ...
    class="[&:hover,&:focus]:text-text-primary dark:[&:hover,&:focus]:text-text-primary-dark [&:hover,&:focus]:bg-active dark:[&:hover,&:focus]:bg-active-dark flex cursor-pointer items-center px-2 pb-[4.5px] pt-[3.5px] uppercase text-text-secondary disabled:opacity-50 dark:text-text-secondary-dark"
