<script lang="ts">
  ...
  const otherLocale: Locale = currentLocale === 'en' ? 'cs' : 'en';
...
>
  <svg class="h-4 w-4" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M8 3H9.5C9.5 9.5 6.5 15.5 2 18.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
    <path d="M16 3H14.5C14.5 9.5 17.5 15.5 22 18.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
    <path d="M3 16V14.5C9.5 14.5 15.5 17.5 18.5 22" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
    <path d="M3 9V10.5C9.5 10.5 15.5 7.5 18.5 2.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
  </svg>
