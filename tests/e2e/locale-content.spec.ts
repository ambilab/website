...
test.describe('English content (default locale)', () => {
    ...
    /** The /news listing should have lang="en" and show the English post title. */
    ...
    /** English detail page /news/hello-world should render lang="en" and the English heading. */
